...
angular.module('sampleAdminWebApp.accountApp').controller('LoginController', function (Principal, $location, $rootScope, $scope, $state, $timeout, Auth, AuthServerProvider, localStorageService, SHA256) {
        ...
        $scope.login = function () {
            var loginPromise = Auth.login({
                ...
                password: SHA256.sha256_digest($scope.password),
